...
const HomePage: React.FC = () => {
  ...
  <div className="flex flex-col gap-12 max-w-4xl mx-auto">
    ...
    <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
      <img src="/assets/undraw_ideation.svg" alt="Ideation" className="w-32 md:w-48 order-1 md:order-none" />
    ...
    <div className="flex flex-col md:flex-row-reverse items-center md:items-start gap-6">
      <img src="/assets/undraw_launch_event.svg" alt="Launch" className="w-32 md:w-48 order-1 md:order-none md:-mt-8" />
    ...
    {/* Timeline Item 3 */}
    <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
      <img src="/assets/undraw_team_spirit.svg" alt="Growth Phase" className="w-32 md:w-48 order-1 md:order-none" />
      <div className="text-left md:ml-8">
        ...
        <div className="container mx-auto px-4 max-w-4xl bg-gray-100 md:bg-gray-50 border-[1px] md:border-0 md:border-t-4 md:rounded-sm rounded-md border-primary-900 pt-8 pb-8">
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            >
              ...
              <Button className='sm:border-[1px] sm:border-black' variant="outline" onClick={() => window.location.href = '/register'}>
                Register Now
              </Button>
            </motion.div>
          </div>
